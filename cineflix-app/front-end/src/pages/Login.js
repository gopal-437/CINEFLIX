  ...
  return (
    <div className={styles.loginContainer}>
      ...
      >
        ...
        <input name='email' placeholder="Enter your Email" className={styles.input} type="text" onChange={handleChange}/>
      </div>
        ...
        <div className={styles.inputForm}>
          <svg width="20" viewBox="-64 0 512 512" height="20">
            <path d="m336 512h-288c-26.453125 0-48-21.523438-48-48v-224c0-26.476562 21.546875-48 48-48h288c26.453125 0 48 21.523438 48 48v224c0 26.476562-21.546875 48-48 48zm-288-288c-8.8125 0-16 7.167969-16 16v224c0 8.832031 7.1875 16 16 16h288c8.8125 0 16-7.167969 16-16v-224c0-8.832031-7.1875-16-16-16zm0 0"></path>
            <path d="m304 224c-8.832031 0-16-7.167969-16-16v-80c0-52.929688-43.070312-96-96-96s-96 43.070312-96 96v80c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-80c0-70.59375 57.40625-128 128-128s128 57.40625 128 128v80c0 8.832031-7.167969 16-16 16zm0 0"></path>
          </svg>
          <input name='password' placeholder="Enter your Password" className={styles.input} type="password" onChange={handleChange}/>
        </div>
        ...
        {/* Submit Button */}
        <button className={styles['button-submit']} onClick={handleSubmit}>Sign In</button>

        {/* Sign Up Link */}
        <p className={styles.p}>Don't have an account? <span className={styles.span} onClick={signupClickHandler}>Sign Up</span></p>
        <p className={`${styles.p} ${styles.line}`}>Or With</p>

        {/* Social Login Buttons */}
        <div className={styles['flex-row']}>
          <button className={`${styles.btn} ${styles.google}`}>
            <svg style={{enableBackground:"new 0 0 512 512"}} viewBox="0 0 512 512" width="20">
          ...
          <button className={`${styles.btn} ${styles.apple}`}>
            <svg style={{enableBackground:"new 0 0 22.773 22.773"}} viewBox="0 0 22.773 22.773" width="20" height="20">
              <g>
